...
const apiaiApp = apiai('a7d1c79358694d408f97b7f8a772a131');
...
app.post('/ai', (req, res) => {
  ...
  if (req.body.result.action === 'weather') {
    ...
    let restUrl = 'http://api.openweathermap.org/data/2.5/weather?APPID='+'818cea3bd65bf4ace834a24d7adca117'+'&q='+city;
